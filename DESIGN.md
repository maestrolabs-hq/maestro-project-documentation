...
Adapted from [VoltAgent/awesome-design-md](https://github.com/VoltAgent/awesome-design-md)
(MIT License), file `design-md/vercel/DESIGN.md`
([commit `987140b5394c2a4ada4ef324f2d19ef66caf4338` blob](https://github.com/VoltAgent/awesome-design-md/blob/main/design-md/vercel/DESIGN.md)).
That collection describes itself as "an inspired interpretation of Vercel's
design language," built from publicly visible CSS values observed on
vercel.com. It makes no claim of ownership over Vercel's visual identity, and
